...
def run_interference_circuit(): 
    ...
    noise_label.grid(row=4, column=0, padx=10, pady=10, sticky="e")
    ...
    noise_slider.grid(row=4, column=1, padx=10, pady=10)
    ...
    button_close.grid(row=6, column=0, columnspan=2, pady=10)
